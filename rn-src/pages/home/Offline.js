    ...
    render() {
        return (
            <View style={styles.container}>
                <TitleBar title={"数据中断"} hideLeftArrow={false}/>
                <RefreshFlatList
                ...
                <View style={styles.item}>
                    <View style={styles.wrapper}>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Image style={styles.readwrapper} source={Images.home_unread} resizeMode={"cover"}></Image>
                        </TouchableOpacity>
                    </View>
...
module.exports = connect(select)(Offline);